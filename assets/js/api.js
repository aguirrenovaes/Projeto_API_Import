//Desenvolvido por Aguirre Matos Novaes
//Curso de Desenvolvimento de Sistemas no Senai Suiço-Brasileiro
...
range = 18; //Variável que define a quantidade de Pokemons Listados
...
'<div class="col s4">'+
'<div class="card red z-depth-3">'+ //indigo lighten-1
...
'<span class="white-text">Nº POKEMON: '+x+' </span>'+
'</div>'+
'</div>'+
'</div>';
